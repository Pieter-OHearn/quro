...
type FormState = {
  name: string; bank: string; balance: string; currency: CurrencyCode;
  rate: string; type: "Easy Access" | "Term Deposit"; emoji: string;
};
...
function InterestPreview({ balance, rate, currency }: { balance: string; rate: string; currency: string }) {
