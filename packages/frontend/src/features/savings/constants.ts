...
export const TXN_META: Record<TxnType, { label: string; icon: typeof ArrowDownLeft; color: string; bg: string; sign: string }> = {
  deposit:    { label: "Deposit",    icon: ArrowDownLeft, color: "text-emerald-600", bg: "bg-emerald-50", sign: "+" },
  interest:   { label: "Interest",   icon: Sparkles,      color: "text-indigo-600",  bg: "bg-indigo-50",  sign: "+" },
  withdrawal: { label: "Withdrawal", icon: ArrowUpRight,  color: "text-rose-500",    bg: "bg-rose-50",    sign: "\u2212" },
};

export const TXN_TYPE_LIST: TxnTypeMeta[] = [
  { key: "deposit",    label: "Deposit",    icon: ArrowDownLeft, color: "text-emerald-600", bg: "bg-emerald-50", borderColor: "border-emerald-300" },
  { key: "interest",   label: "Interest",   icon: Sparkles,      color: "text-indigo-600",  bg: "bg-indigo-50",  borderColor: "border-indigo-300" },
  { key: "withdrawal", label: "Withdrawal", icon: ArrowUpRight,  color: "text-rose-500",    bg: "bg-rose-50",    borderColor: "border-rose-300" },
];
