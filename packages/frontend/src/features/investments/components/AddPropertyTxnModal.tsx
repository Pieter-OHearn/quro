      ...
      {type === 'valuation' && (
        <div className="space-y-1.5">
          ...
          <div className="flex justify-between text-xs">
            ...
            <span
              className={`font-semibold ${parsedAmount >= property.currentValue ? 'text-emerald-600' : 'text-rose-500'}`}
            >
              {fmtNative(parsedAmount, property.currency, true)}
            </span>
          </div>
      ...
      {type === 'rent_income' && (
        <div className="space-y-1.5">
          ...
          <div className="flex justify-between text-xs">
            ...
            <span
              className={`font-semibold ${parsedAmount >= property.monthlyRent ? 'text-emerald-600' : 'text-amber-600'}`}
            >
      ...
      {type === 'expense' && (
        <div className="space-y-1.5">
          ...
          <div className="flex justify-between text-xs">
            ...
            <span
              className={`font-semibold ${property.monthlyRent - parsedAmount >= 0 ? 'text-emerald-600' : 'text-rose-600'}`}
            >
