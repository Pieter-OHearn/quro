                ...
                {[
                  {
                    dot: 'bg-white/80',
                    label: 'Q Arc',
                    desc: '315° clockwise ring — the letterform anchor',
                  },
                  {
                  ...
                  },
                  {
                    dot: 'bg-indigo-400',
                    label: 'Tail',
                    desc: 'Bezier sweep, tangent-smooth to arc end',
                  },
                  {
                    dot: 'bg-purple-400',
                    label: 'Tail tip',
                    desc: 'Gradient endpoint — growth accent',
                  },
                  {
                    dot: 'bg-white/50',
                    label: 'Centre dot',
                    desc: 'Grounds the composition visually',
                  },
                ].map(({ dot, label, desc }) => (
