          ...
          <div className="border-t border-slate-100 px-6 py-4 bg-slate-50/30">
            ...
            {foreign && (
              <div className="mb-3 p-2.5 bg-amber-50 border border-amber-100 rounded-xl flex items-start gap-2 text-xs text-amber-700">
                ...
                <span>
                  This pot is held in <strong>{pot.currency}</strong>. The {baseCurrency} equivalent
...
export function Pension(): JSX.Element {
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <PensionSummaryStats
        totalInBase={totalInBase}
        totalMonthlyContribInBase={totalMonthlyContribInBase}
        monthlyDrawdown={monthlyDrawdown}
        pensionsCount={pensions.length}
        fmtBase={fmtBase}
      />
      <PensionGrowthChart
        pensionGrowthData={pensionGrowthData}
        pensionGrowthPct={pensionGrowthPct}
        fmtBase={fmtBase}
        baseCurrency={baseCurrency}
      />
      <PensionPotsList
        ...
        setAddTxnForPot={setAddTxnForPot}
        deletePot={deletePot}
        handleDeletePensionTxn={handleDeletePensionTxn}
        fmtBase={fmtBase}
        fmtNative={fmtNative}
        convertToBase={convertToBase}
        isForeign={isForeign}
